 ...
 * 2014-05-21T17:30:45.667+01:00
 * Generated source version: 2.7.5
 */
@WebServiceClient(name = "SdtEndpoint",
        wsdlLocation = "src/main/resources/wsdl/SdtEndpointDist.wsdl",
...
public class SdtEndpoint extends Service {
    ...
    static {
        URL url = SdtEndpoint.class.getResource("src/main/resources/wsdl/SdtEndpointDist.wsdl");
        if (url == null) {
            url = SdtEndpoint.class.getClassLoader().getResource("src/main/resources/wsdl/SdtEndpointDist.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(SdtEndpoint.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "src/main/resources/wsdl/SdtEndpointDist.wsdl");
        }
        WSDL_LOCATION = url;
    }
    ...
    /**
     * @return returns ISdtEndpointPortType
     */
