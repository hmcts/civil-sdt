...
@Configuration
public class CommissioningSubmitQueryRequestMCOLDefence3 {
    @Bean
    @Qualifier("ISubmitQueryRequestMCOLDefence3")
    public static ISubmitQueryRequest submitQueryRequestMCOLDefence3() {
        SubmitQueryRequest submitQueryRequest = new SubmitQueryRequest();
        submitQueryRequest.setResultCount(0);
        submitQueryRequest.setErrorLog(errorLogMCOLDefence3());
        submitQueryRequest.setTargetApplicationResponse(
            """
                <![CDATA[
                    <sub:mcolDefenceDetail xmlns:sub="http://ws.sdt.moj.gov.uk/2013/sdt/SubmitQueryResponseSchema"
                        xmlns:mquer="http://ws.sdt.moj.gov.uk/2013/mcol/QuerySchema">
    ...
    @Bean
    @Qualifier("IErrorLogMCOLDefence3")
    private static IErrorLog errorLogMCOLDefence3() {
        return new ErrorLog("78", "Results truncated - maximum number allowed reached.");
    }
}
