...
@Configuration
public class CommissioningBulkFeedbackB00000001 {
    @Bean
    @Qualifier("IBulkSumissionB00000001")
    private static IBulkSubmission bulkSumissionB00000001() {
    ...
    @Bean
    @Qualifier("BulkFeedbackFactoryB00000001")
    private static BulkFeedbackFactory bulkFeedbackFactoryB00000001(@Qualifier("IBulkSumissionB00000001")
                                                            IBulkSubmission bulkSubmission) {
        return new BulkFeedbackFactory(bulkSubmission);
    }

    @Bean
    @Qualifier("createIndividualRequestB00000001")
    public static MethodInvokingFactoryBean createIndividualRequestB00000001() {
        MethodInvokingFactoryBean methodInvokingFactoryBean = new MethodInvokingFactoryBean();
        methodInvokingFactoryBean.setTargetObject(bulkFeedbackFactoryB00000001(bulkSumissionB00000001()));
        ...
        List<List<String>> arguments = List.of(
            ...
            List.of("USER_REQUEST_ID_B3", "mcolJudgment", "Initially Accepted", "", "",
                    """
                        <![CDATA[
                        ...
                        """),
            List.of("USER_REQUEST_ID_B4", "mcolClaimStatusUpdate", "Initially Accepted", "", "", ""),
            List.of("USER_REQUEST_ID_B5", "mcolJudgment", "Rejected", "24", "This judgment request is invalid on the referenced claim.", ""),
            List.of("USER_REQUEST_ID_B6", "mcolWarrant", "Initially Accepted", "", "",
                    """
                        <![CDATA[
                          <ind:mcolResponseDetail xmlns:ind="http://ws.sdt.moj.gov.uk/2013/sdt/BulkFeedbackResponseSchema" xmlns:mresp="http://ws.sdt.moj.gov.uk/2013/mcol/ResponseDetailSchema">
                        ...
                        """),
            List.of("USER_REQUEST_ID_B7", "mcolJudgmentWarrant", "Initially Accepted", "", "",
                    """
                        <![CDATA[
                          <ind:mcolResponseDetail xmlns:ind="http://ws.sdt.moj.gov.uk/2013/sdt/BulkFeedbackResponseSchema" xmlns:mresp="http://ws.sdt.moj.gov.uk/2013/mcol/ResponseDetailSchema">
            ...
            List.of("USER_REQUEST_ID_B10", "mcolJudgmentWarrant", "Rejected", "24", "This judgment request is invalid on the referenced claim.",
                    """
                        ...
                        """),
            List.of("USER_REQUEST_ID_B11", "mcolClaim", "Initially Accepted", "", "",
                    """
                        <![CDATA[
                            <ind:mcolResponseDetail xmlns:ind="http://ws.sdt.moj.gov.uk/2013/sdt/BulkFeedbackResponseSchema" xmlns:mresp="http://ws.sdt.moj.gov.uk/2013/mcol/ResponseDetailSchema">
                        ...
                        """),
            List.of("USER_REQUEST_ID_B12", "mcolWarrant", "Forwarded", "", "", ""),
            List.of("USER_REQUEST_ID_B13", "mcolJudgment", "Awaiting Data", "", "", ""),
            List.of("USER_REQUEST_ID_B14", "mcolClaim", "Received", "", "", ""),
            List.of("USER_REQUEST_ID_B15", "mcolJudgment", "Received", "", "", ""),
            List.of("USER_REQUEST_ID_B16", "mcolSetAside", "Initially Accepted", "", "",
                    """
                        <![CDATA[
                            <ind:mcolResponseDetail xmlns:ind="http://ws.sdt.moj.gov.uk/2013/sdt/BulkFeedbackResponseSchema" xmlns:mresp="http://ws.sdt.moj.gov.uk/2013/mcol/ResponseDetailSchema">
                        ...
                        """),
            List.of("USER_REQUEST_ID_B17", "mcolBreathingSpace", "Initially Accepted", "", "", "")
        );
