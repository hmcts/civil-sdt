  ...
  CREATE OR REPLACE PROCEDURE "PUBLIC"."FINISH_DBUNIT_LOAD"
(
...
/
  ...
  CREATE OR REPLACE PROCEDURE "PUBLIC"."PREPARE_FOR_DBUNIT_LOAD"
(
  p_SchemaName varchar2
)
AUTHID CURRENT_USER is
...
/
  ...
  CREATE OR REPLACE PROCEDURE "PUBLIC"."PURGE" (i_CommitInterval  IN NUMBER) AS
