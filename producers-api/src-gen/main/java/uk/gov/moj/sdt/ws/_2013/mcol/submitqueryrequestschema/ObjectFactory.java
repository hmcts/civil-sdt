 ...
 * generated in the uk.gov.moj.sdt.ws._2013.mcol.submitqueryrequestschema package. 
...
public class ObjectFactory {
    ...
    private final static QName _SubmitQueryRequest_QNAME = new QName("http://ws.sdt.moj.gov.uk/2013/mcol/SubmitQueryRequestSchema", "submitQueryRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: uk.gov.moj.sdt.ws._2013.mcol.submitqueryrequestschema
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.sdt.moj.gov.uk/2013/mcol/SubmitQueryRequestSchema", name = "submitQueryRequest")
