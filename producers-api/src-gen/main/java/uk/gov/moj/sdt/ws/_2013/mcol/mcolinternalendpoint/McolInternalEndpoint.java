 ...
 * 2013-08-23T15:54:25.786+01:00
 * Generated source version: 2.7.5
 * 
 */
@WebServiceClient(name = "McolInternalEndpoint", 
                  wsdlLocation = "src/main/resources/wsdl/McolInternalEndpointGeneric.wsdl",
...
public class McolInternalEndpoint extends Service {
    ...
    static {
        URL url = McolInternalEndpoint.class.getResource("src/main/resources/wsdl/McolInternalEndpointGeneric.wsdl");
        if (url == null) {
            url = McolInternalEndpoint.class.getClassLoader().getResource("src/main/resources/wsdl/McolInternalEndpointGeneric.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(McolInternalEndpoint.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/resources/wsdl/McolInternalEndpointGeneric.wsdl");
        }       
        WSDL_LOCATION = url;
    }
