 ...
 * 2013-07-04T15:15:54.236+01:00
 * Generated source version: 2.7.5
 * 
 */
@WebServiceClient(name = "SdtEndpoint", 
                  wsdlLocation = "src/main/resources/wsdl/SdtGatewayEndpoint.wsdl",
...
public class SdtEndpoint extends Service {
    ...
    static {
        URL url = SdtEndpoint.class.getResource("src/main/resources/wsdl/SdtGatewayEndpoint.wsdl");
        if (url == null) {
            url = SdtEndpoint.class.getClassLoader().getResource("src/main/resources/wsdl/SdtGatewayEndpoint.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(SdtEndpoint.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/resources/wsdl/SdtGatewayEndpoint.wsdl");
        }       
        WSDL_LOCATION = url;
    }
