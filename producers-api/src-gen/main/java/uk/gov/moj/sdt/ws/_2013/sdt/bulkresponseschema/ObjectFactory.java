...
public class ObjectFactory {
    ...
    private static final QName _BulkResponse_QNAME = new QName("http://ws.sdt.moj.gov.uk/2013/sdt/BulkResponseSchema", "bulkResponse");
    ...
    public JAXBElement<BulkResponseType> createBulkResponse(BulkResponseType value) {
        return new JAXBElement<>(_BulkResponse_QNAME, BulkResponseType.class, null, value);
    }
