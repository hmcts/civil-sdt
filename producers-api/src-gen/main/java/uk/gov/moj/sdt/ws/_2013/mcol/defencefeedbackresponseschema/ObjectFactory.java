 ...
 * generated in the uk.gov.moj.sdt.ws._2013.mcol.defencefeedbackresponseschema package. 
...
public class ObjectFactory {
    ...
    private final static QName _DefenceResponse_QNAME = new QName("http://ws.sdt.moj.gov.uk/2013/mcol/DefenceFeedbackResponseSchema", "defenceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: uk.gov.moj.sdt.ws._2013.mcol.defencefeedbackresponseschema
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.sdt.moj.gov.uk/2013/mcol/DefenceFeedbackResponseSchema", name = "defenceResponse")
