...
CREATE SEQUENCE public.bulk_cust_app_seq MINVALUE 1 MAXVALUE  999999999999999999 INCREMENT BY 50 START WITH 1 NO CYCLE;
CREATE SEQUENCE public.bulk_cust_seq MINVALUE 1 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1 NO CYCLE;
CREATE SEQUENCE public.bulk_sub_seq MINVALUE 1 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1 NO CYCLE;
CREATE SEQUENCE public.err_log_seq MINVALUE 1 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1 NO CYCLE;
CREATE SEQUENCE public.err_mesg_seq MINVALUE 1 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1 NO CYCLE;
CREATE SEQUENCE public.glb_par_seq MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 50 START WITH 1 CYCLE;
CREATE SEQUENCE public.ind_req_seq MINVALUE 1 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1 CACHE 2000 NO CYCLE;
CREATE SEQUENCE public.sdt_ref_seq MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 50 START WITH 1 CYCLE;
CREATE SEQUENCE public.ser_rou_seq MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 50 START WITH 1 CYCLE;
CREATE SEQUENCE public.ser_typ_seq MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 50 START WITH 1 CYCLE;
CREATE SEQUENCE public.srv_req_seq MINVALUE 1 MAXVALUE 999999999999999999 INCREMENT BY 50 START WITH 1 NO CYCLE;
CREATE SEQUENCE public.tar_app_seq MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 50 START WITH 1 CYCLE;
