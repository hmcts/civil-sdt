...
public final class SdtMetricsMBean implements ISdtMetricsMBean {
    ...
    public String getBulkSubmitStats() {
        ...
        return new StringBuilder().append("Bulk submits: count[").append(this.getBulkSubmitCount()).append("], last[")
                .append(this.formatter.format(bulkSubmitLastTime)).append("], rate[")
                .append(this.getRate(this.getBulkSubmitCount(), this.getElapsedTime())).append("], requests[")
                .append(this.getRequestCount()).append("], rate[").append(this.getRate(this.getRequestCount(),
                        this.getElapsedTime())).append("], time[").append(this.getBulkSubmitTime())
                .append("], average[").append(this.getBulkSubmitTimeAvg()).append("], minimum[")
                .append(this.getBulkSubmitTimeMin()).append("], maximum[").append(this.getBulkSubmitTimeMax())
                .append("]").toString();
    }
