...
<mresp:enforcingCourtName>Court Code</mresp:enforcingCourtName><mresp:fee>0</mresp:fee><mresp:judgmentWarrantStatus>tns additionalStatus</mresp:judgmentWarrantStatus></ind:mcolResponseDetail>', 'mcolClaim', 0, 'N');
